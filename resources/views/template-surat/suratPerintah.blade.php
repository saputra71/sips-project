    ...
    <div class="book">
        <div class="page">
            <div class="subpage">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <span style="font-size: 18px; font-weight: bold;">SMK NEGERI 11 BANDUNG</span><br />
                                Bisnis dan Manajemen - Teknologi Informasi dan Komunikasi - Seni dan Ekonomi Kreatif<br />
                ...
                <div class="content" style="margin: 20px 30px 20px 30px; text-align: justify; padding-right: 30px;">{!! $untuk !!}</div>
                <br>
                <table style="width: 100%; margin: 20px 30px 0 30px;">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <!-- <td style="width: 25%; padding-top: 20px; text-align: center;"><img src="{{ $qr_code }}" alt="qr_code" width="100"></td> -->
