...
class NewIngoingMailNotification extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($ingoingMail, $authUser)
    {
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            // 'message' => 'Surat masuk baru telah ditambahkan oleh ' . $this->authUser . '-' . $this->auth()->user()->roles->first()->name,
